...
const About = () => (
  ...
  >
    <div className="content">
      ...
      <p>
        You can check out my <Link to="/bookshelf/">bookshelf</Link> to read
        notes on books I've read, or visit my{" "}
        <a
      ...
      <p>
        ...
        (VBA), and ELM, but I haven't programmed in those languages in years.
        I've enjoyed trying my hand at Bootstrap, GraphQL, and WordPress through
